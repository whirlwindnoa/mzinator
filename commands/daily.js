module.exports = {
    ...
    async execute(message, args) {
        ...
        if ((time - lastclaim) < 86400) {
            ...
            message.channel.send(`:x: You may claim your reward again in **${Math.floor(hours)} hours, ${Math.ceil(minutes)} minutes**.`);
            return;
        }
        ...
        message.channel.send(`:voxneruda: **${message.author.username}**, you claimed your **${count}** vmims!`);
        return; 
    }
}